...
[ Render Web Service ]
  ...
  - Region: Singapore
        ...
        ↓
[ SQLite Database ]
  - Path: /tmp/habitflow.db
  - Managed by the application layer
        
[ GitHub Repository ] ──── auto-deploy on push ──→ [ Render Web Service ]
```

**Public components:** Render Web Service (accessible via HTTPS URL)  
